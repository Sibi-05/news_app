...
const Health = () => {
  ...
  const renderHealthNews = () => {
    ...
    return newsSources.articles.map((cur, ind) => {
      return (
        <div key={ind} className="col-xl-4 col-md-6 mb-3">
  ...
  return (
    <div className="container-lg">
      <h1 className="my-4">Health NEWS</h1>
      <div className="row"> {renderHealthNews()}</div>
    </div>
  );
};
